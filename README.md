...
**Todo List** is a website that allow users to create a list of dayly tasks and re-order and delete them.
...
- **Re-order the postition of tasks**
...
```sh
  git clone https://github.com/kazim110/Todo-list-webpack.git
```
...
This project is [MIT](https://github.com/kazim110/Todo-list-webpack/blob/main/LICENSE) licensed.
